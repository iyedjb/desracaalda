...
class RTDBStorage implements IStorage {
  ...
  constructor() {
    try {
      // Helper to handle production env vars with potential newlines
      ...
      const mainConfig = {
        apiKey: getEnv("FIREBASE_API_KEY", "AIzaSyDdNLa9sgFztIE90i9B7F8aHKtksJLaA-I"),
        authDomain: getEnv("FIREBASE_AUTH_DOMAIN", "roda-bem-turismo.firebaseapp.com"),
        databaseURL: getEnv("FIREBASE_DATABASE_URL", "https://roda-bem-turismo-default-rtdb.firebaseio.com"),
        projectId: getEnv("FIREBASE_PROJECT_ID", "roda-bem-turismo"),
        storageBucket: getEnv("FIREBASE_STORAGE_BUCKET", "roda-bem-turismo.firebasestorage.app"),
        messagingSenderId: getEnv("FIREBASE_MESSAGING_SENDER_ID", "732861766010"),
        appId: getEnv("FIREBASE_APP_ID", "1:732861766010:web:a268ba64b148ac09a99ec3"),
        measurementId: getEnv("FIREBASE_MEASUREMENT_ID", "G-0Y9ZPTWPWZ")
      };
      ...
      const rhConfig = {
        apiKey: getEnv("FIREBASE_RH_API_KEY", "AIzaSyB47aV1YCX-WgBK3awroJ6ucC79XDFsQdc"),
        authDomain: getEnv("FIREBASE_RH_AUTH_DOMAIN", "cidade-dofuturo.firebaseapp.com"),
        databaseURL: getEnv("FIREBASE_RH_DATABASE_URL", "https://cidade-dofuturo-default-rtdb.firebaseio.com"),
        projectId: getEnv("FIREBASE_RH_PROJECT_ID", "cidade-dofuturo"),
        storageBucket: getEnv("FIREBASE_RH_STORAGE_BUCKET", "cidade-dofuturo.firebasestorage.app"),
        messagingSenderId: getEnv("FIREBASE_RH_MESSAGING_SENDER_ID", "486900760147"),
        appId: getEnv("FIREBASE_RH_APP_ID", "1:486900760147:web:2c70ee9009e28675a350a6"),
        measurementId: getEnv("FIREBASE_RH_MEASUREMENT_ID", "G-9C544QZGNJ")
      };
